...
function variables() {
	...
	$testScreenChilds = $('[data-test-role="testScreen"], [data-test-role="questionTitle"], [data-test-role="questionText"],[data-test-role="answersHolder"]')
	...
	$currentQuestion = 1 //Текущий вопроc.
	...
	$quiz = [
		...
		//Вопрос 6
		{
			...
			"textAnswers": [],
			"imgAnswers": [
				"images/37/main/places/church-of-icon-of-god-mother.jpg", "images/37/main/places/intercession-church.jpg", "images/37/main/places/ascension-church.jpg", "images/37/main/places/i-don-t-know-what-church-it-is.jpg"
			],
			"trueAnswer": $a2
		},
		//Вопрос 7
		...
		//Вопрос 8
		{
			...
			"questionImg": "images/37/main/streets/sovetskaya-st-furmanov.jpg",
			"textAnswers": [
		...
		//Вопрос 10
		{
			...
			"questionImg": "images/37/main/streets/nijnii-dvor-st-furmanov.jpg",
			"textAnswers": [
				"Школа для рабочих",
				"Рабочие казармы",
				"Техническое училище",
...
function showQuestion(currentQuestion) {
	...
	if ($answersImgData) {
		for (i = 0; i < 4; i++) {
			...
			$('[data-test-role="answer' + i + 'Holder"] > *').remove()
...
function finishTest() {
	...
	$restartTrigger.click(function () { //Запуск теста
		restartingTest()
	})
}

function restartingTest() {
	$finishScreen.fadeOut()
	$finishScreenChilds.fadeOut()

	$currentQuestion = 1

	setTimeout(function () {
		$testScreen.fadeIn()
		$testScreenChilds.fadeIn()
		showQuestion($currentQuestion)
	}, 500)
}
